...
namespace TesteICI.Infra.CrossCutting.Security.Extensions
{
    public class IdentityPortugueseMessages : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidToken() { return new IdentityError { Code = nameof(InvalidToken), Description = "Token invÃ¡lido." }; }
        ...
        public override IdentityError UserNotInRole(string role) { return new IdentityError { Code = nameof(UserNotInRole), Description = $"UsuÃ¡rio nÃ£o tem a permissão '{role}'." }; }
